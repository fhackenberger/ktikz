...
#ifdef KTIKZ_USE_KDE
LineEdit::LineEdit(const QString &text, QWidget *parent) : KLineEdit(text, parent)
{
...
QSize LineEdit::sizeHint() const
{
    ...
    const int minimumHeight = m_clearButton->sizeHint().height()
...
void LineEdit::resizeEvent(QResizeEvent *event)
{
    ...
    m_clearButton->move(rect().right() - style()->pixelMetric(QStyle::PM_DefaultFrameWidth)
                                - sz.width(),
